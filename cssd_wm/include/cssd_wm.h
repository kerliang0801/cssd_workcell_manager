...
private:
  ...
  rclcpp::Subscription<cssd_msgs::msg::DispenserResult>::SharedPtr RAWMRespond_;  
  rclcpp::Subscription<cssd_msgs::msg::DispenserState>::SharedPtr RAWMState_;    
  rclcpp::Publisher<cssd_msgs::msg::InventoryCheckResponse>::SharedPtr InventoryCheckResponse_;
  rclcpp::Publisher<cssd_msgs::msg::DispenserRequest>::SharedPtr RAWMRequest_;
  rclcpp::Publisher<cssd_msgs::msg::DispenserResult>::SharedPtr DispenserResponsd_;
  ...
  void inventory_check_callback(const cssd_msgs::msg::InventoryCheckRequest::SharedPtr msg);
  ...
  void RAWM_respond_callback(const cssd_msgs::msg::DispenserResult::SharedPtr msg);
  //update RAWM status when RAWM send response

  void RAWM_state_callback(const cssd_msgs::msg::DispenserState::SharedPtr msg);
  //update RAWM status when RAWM send periodic status updates

  void dispenser_request_callback(const cssd_msgs::msg::DispenserRequest::SharedPtr msg);
